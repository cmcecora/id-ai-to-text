---
description: Generate UI designs using HTML and Tailwind CSS
argument-hint: <description of UI to create>
---
...
Don't mention about token, Tailwind, or HTML.
Always include the html, head, and body tags.
Use lucide icons for javascript, 1.5 strokewidth.
Unless style is specified by the user, design in the style of Linear, Stripe, Vercel, Tailwind UI (Important: don't mention names).
...
For the font weight, use one level thinner: for example, Bold should be Semibold.
...
If no images are specified, use the Unsplash images like faces, 3d, render, etc.
Be creative with fonts, layouts, extremely detailed and make it functional.
